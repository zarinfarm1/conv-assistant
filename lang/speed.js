...
(function(){
  ...
  var css = [
    ...
    '.speed-hero{text-align:center;padding:24px 16px;background:linear-gradient(135deg,#c2410c,#a83a00);color:#fff;border-radius:22px;margin-bottom:16px}',
    '.speed-hero h1{color:#fff;margin:0 0 6px;font-size:1.5rem}',
    '.speed-hero p{margin:0;opacity:.9;font-size:.95rem}',
    ...
    '.speed-opt{padding:14px;border-radius:14px;background:#fff;border:2px solid #cddada;text-align:center;cursor:pointer;transition:all .15s}',
    '.speed-opt:hover{border-color:#c2410c}',
    '.speed-opt.on{background:#ffedd5;border-color:#c2410c;color:#c2410c}',
    ...
    '.speed-timer .track{fill:none;stroke:#cddada;stroke-width:10}',
    '.speed-timer .prog{fill:none;stroke:#23906a;stroke-width:10;stroke-linecap:round;transition:stroke-dashoffset .3s linear, stroke .3s}',
    '.speed-timer.warn .prog{stroke:#f2b134}',
    '.speed-timer.danger .prog{stroke:#d64550}',
    '.speed-timer .num{position:absolute;inset:0;display:grid;place-items:center;font:800 3rem Lexend,sans-serif;color:#14213d}',
    '.speed-timer.warn .num{color:#f2b134}',
    '.speed-timer.danger .num{color:#d64550;animation:pulse .5s infinite}',
    '.speed-question{background:#fff;border:1px solid #cddada;border-radius:20px;padding:26px 20px;text-align:center;max-width:560px;width:100%;margin-bottom:20px;min-height:100px;display:flex;align-items:center;justify-content:center}',
    '.speed-question .q-en{font:600 1.3rem Lexend,sans-serif;line-height:1.5;direction:ltr}',
    '.speed-question .q-role{font-size:.8rem;color:#5b6b80;margin-bottom:10px}',
    '.speed-question .q-hint{font-size:.85rem;color:#5b6b80;margin-top:12px;border-top:1px dashed #cddada;padding-top:10px}',
    '.speed-mic-wrap{display:flex;flex-direction:column;align-items:center;gap:12px;width:100%;max-width:560px}',
    '.speed-big-mic{width:90px;height:90px;border-radius:50%;background:#c2410c;color:#fff;border:0;cursor:pointer;display:grid;place-items:center;font-size:2rem;box-shadow:0 8px 24px rgba(194,65,12,.3);transition:all .15s}',
    '.speed-big-mic:active{transform:scale(.95)}',
    '.speed-big-mic.rec{background:#d64550;animation:ring 1.4s infinite}',
    '.speed-big-mic:disabled{opacity:.5;cursor:not-allowed}',
    '.speed-transcript{font-size:1.1rem;font-family:Lexend,sans-serif;direction:ltr;text-align:center;color:#5b6b80;min-height:1.5em;padding:8px}',
    '.speed-transcript.has-text{color:#14213d}',
    '.speed-type-row{display:flex;gap:8px;width:100%}',
    '.speed-type-row input{flex:1;padding:12px 16px;border-radius:999px;border:1.5px solid #cddada;font-family:Lexend,sans-serif;direction:ltr}',
    '.speed-type-row button{padding:0 20px;border-radius:999px;background:#14213d;color:#e9f1f1;font-weight:700;border:0;cursor:pointer}',
    '.speed-result{background:#fff;border:1px solid #cddada;border-radius:20px;padding:20px;max-width:600px;width:100%;margin-top:16px}',
    '.speed-result h3{margin:0 0 12px;display:flex;align-items:center;gap:8px;flex-wrap:wrap}',
    '.speed-result .time-badge{display:inline-block;padding:3px 12px;border-radius:999px;font-weight:700;font-size:.85rem}',
    '.speed-result .time-badge.great{background:#d8f1e6;color:#23906a}',
    '.speed-result .time-badge.ok{background:#fdf0d0;color:#a86d00}',
    '.speed-result .time-badge.bad{background:#fbe0e2;color:#d64550}',
    '.speed-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin:14px 0;width:100%;max-width:600px}',
    '.speed-stats .st{text-align:center;padding:10px;background:#fff;border-radius:12px;border:1px solid #cddada}',
    '.speed-stats .st b{display:block;font-size:1.3rem;font-family:Lexend,sans-serif;color:#c2410c}',
    '.speed-stats .st small{font-size:.72rem;color:#5b6b80}',
    '.speed-skip{background:transparent;border:1.5px solid #cddada;color:#5b6b80;padding:8px 20px;border-radius:999px;font-size:.88rem;cursor:pointer;margin-top:12px}',
    '.speed-skip:hover{border-color:#d64550;color:#d64550}'
  ].join('\n');
